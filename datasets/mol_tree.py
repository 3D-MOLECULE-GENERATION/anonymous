import sys
sys.path.append("..")
sys.path.append("/home/csy/work/3D/tragetdiff_phar/datasets")
sys.path.append("/home/csy/work/3D/tragetdiff_phar")
import rdkit
...
class MolTree(object):
    def __init__(self, mol, reference):
        ...
        cliques, edges = tree_decomp(self.mol, reference)
        self.nodes = []
        root = 0
